...
phenoData <- (phenoData + .15 * snp1$data$observed$snp + .12 * snp2$data$observed$snp)
...
# Add the effect of the SNPs to the latent variable
phenoData <- (phenoData + .13 * snp3$data$observed$snp + .10 * snp4$data$observed$snp)
...
# Add the effect of the SNPs to the latent variable
phenoData <- (phenoData + .11 * snp5$data$observed$snp + .09 * snp6$data$observed$snp)
...
# Add the effect of the SNPs to the latent variable
phenoData <- (phenoData + .14 * snp7$data$observed$snp + .12 * snp8$data$observed$snp)
